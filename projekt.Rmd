...
```{r graf.trgovanja.uvoz, echo=FALSE, message=FALSE, warning = FALSE}
...
```{r graf.trgovanja.izvoz, echo=FALSE, message=FALSE, warning = FALSE}
...
```{r graf.bdp.populacija.izvoz, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(graf.bdp.populacija.izvoz)
```
```{r graf.bdp.populacija.uvoz, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(graf.bdp.populacija.uvoz)
```
  **Opomba:** 
- Qatar sem kot osamelca izločil, saj je tako graf dosti bolj pregleden
- Velikost točk je pogojena s številom prebivalcev
...
```{r graf.bdp.povrsina.izvoz, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(graf.bdp.povrsina.izvoz)
```
```{r graf.bdp.povrsina.uvoz, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(graf.bdp.povrsina.uvoz)
```
**Opomba:** 
- Velikost točk je pogojena z velikostjo površine
